...
python3 train_relations.py --train_option between_sentence_lstm  --epochs 20 --path_dev_data preprocessed_data/sci_dev.data  --path_bert between_bert_temp.pt  --dest_path between_tagger_temp.pt --batch_size  16 --learning_rate 2e-5 --weight_decay  1e-4
